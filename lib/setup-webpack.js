...
module.exports = (
  ...
  config
    .plugin('define')
    .tap((args) => {
      args[0]['process.env'].SSR_SIDE = JSON.stringify(SSR_SIDE);
      return args;
    });

  if (typeof defaultConfig.chainWebpackCallback === 'function') {
    defaultConfig.chainWebpackCallback(config, SSR_SIDE, MODE);
  }
